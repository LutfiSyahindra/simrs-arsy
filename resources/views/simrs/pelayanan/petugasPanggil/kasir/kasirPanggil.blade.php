...
@section("content")
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1">Petugas Panggil Kasir</h4>
            <p class="text-muted mb-0">Manajemen antrian Kasir</p>
        </div>
        <nav>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">Daftar Antrian Kasir</h6>
                </div>
...
@push("scripts")
    @include("simrs.pelayanan.petugasPanggil.kasir.jsMain")
@endpush
