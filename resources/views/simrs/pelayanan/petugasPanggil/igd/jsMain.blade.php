<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '{{ route("pelayanan.petugasPanggil.igd.igdPanggil.dataPasien") }}',
            method: 'GET',
            dataType: 'json',
            success: function(response) {
                ...
                $.each(response, function(index, item) {
                    var button =
                        '<button class="btn btn-info panggil-pasienIgd" ' +
        ...
        $('#fixed-header-datatable tbody').on('click', '.panggil-pasienIgd', function() {
            ...
            $.ajax({
                url: '{{ route("pelayanan.petugasPanggil.igd.igdPanggil.panggilIgd") }}',
                method: 'POST',
                data: {
                    nama: namaPasien,
                    poli: poli,
