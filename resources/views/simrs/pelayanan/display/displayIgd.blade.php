    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                const channel = pusher.subscribe("panggilan-igdV2");
                ...
                channel.bind("PanggilIgdV2", function(data) {
                    console.log("Data diterima dari Pusher:", data);
                ...
                function formatPatientName(pasien) {
                    const gelarMap = {
                        ...
                        "SDR": "Saudara",
                        "BY": "Bayi",
                        "HJ": "Hajah", // default perempuan
                        "H": "Haji"
                    };

                    // Normalisasi: hapus titik & rapikan spasi
                    pasien = pasien.replace(/[.,]/g, " ").replace(/\s+/g, " ").trim();

                    const parts = pasien.split(" ");

                    let gelarSet = new Set();
                    let nama = [];
                    ...
                    if (gelarSet.has("HJ")) {
                        if (gelarSet.has("NY")) {
                            gelarFinal.push("Nyonya", "Hajah");
                        } else if (gelarSet.has("TN")) {
                            gelarFinal.push("Tuan", "Haji");
                        } else {
                            // fallback jika hanya HJ tanpa NY/TN
                            gelarFinal.push("Hajah");
                        }
                    } else if (gelarSet.has("H")) {
                        gelarFinal.push("Haji");
                    } else {
                        if (gelarSet.has("NY")) gelarFinal.push("Nyonya");
                        if (gelarSet.has("TN")) gelarFinal.push("Tuan");
                    }
                    ...
                    return `${gelarFinal.join(" ")} ${namaFinal}`.trim();
                }
                ...
                function speakQueue(dokter, poli, nomor, pasien) {
                    if ('speechSynthesis' in window) {
                        ...
                        let text =
                            `Panggilan Untuk Keluarga:${formattedPasien}, Agar Datang Ke Ruang I Ge D RS Arsy`;
