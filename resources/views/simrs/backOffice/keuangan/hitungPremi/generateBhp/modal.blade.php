        ...
        <div class="modal-content border-0 rounded-3">
            <div class="modal-header border-0 pb-0">
                <div>
                    ...
                    <small class="text-muted">Masukkan nominal per pasien untuk tiap ploting</small>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Total BHP per ploting = jumlah pasien yang memenuhi kriteria x nominal masing-masing ploting.
                        </small>
                    </div>
                </div>
