...
@push("style")
    ...
    <style>
        ...
        .icu-hero {
            align-items: stretch;
            background: linear-gradient(135deg, #fff 0%, #fff7ed 48%, #ecfeff 100%);
        ...
        .icu-summary-total-card {
            background: linear-gradient(135deg, #fff1f2 0%, #fff 44%, #ecfeff 100%);
            border-left: 5px solid var(--icu-main);
            display: grid;
            gap: 12px;
            padding: 14px;
        ...
        .icu-detail-hero {
            align-items: flex-start;
            background: linear-gradient(135deg, #fff 0%, #fff7ed 50%, #ecfeff 100%);
            border: 1px solid #e2e8f0;
            border-left: 5px solid var(--icu-main);
            border-radius: 8px;
            display: flex;
...
@section("content")
    <div class="icu-page">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Generate ICU</li>
            </ol>
        </nav>

        <section class="icu-hero">
            <div class="icu-hero-main">
                <div class="icu-hero-icon"><i class="mdi mdi-heart-pulse"></i></div>
                <div>
                    <div class="icu-eyebrow">ICU Premium Generator</div>
                    <h4 class="icu-title">Generate Premi ICU</h4>
                    <p class="icu-description">
                        Data diambil dari pasien rawat inap dengan riwayat ICU, tindakan rawat jalan/inap yang sesuai mapping,
                        dan tindakan kritikal ICU khusus.
                    </p>
            ...
            <div class="icu-hero-controls">
                <div class="icu-control-box">
                    ...
                    <div class="icu-period-picker">
                        <button type="button" class="btn btn-light icu-period-step" id="btnPrevIcu" title="Periode sebelumnya">
                            <i class="mdi mdi-chevron-left"></i>
                        </button>
                        <input type="month" class="form-control" id="periodeIcu">
                        <button type="button" class="btn btn-light icu-period-step" id="btnNextIcu" title="Periode berikutnya">
        ...
        <section class="icu-panel">
            <div class="icu-filter-bar">
                <div>
                    <div class="icu-panel-title">Riwayat Generate ICU</div>
    ...
    @include("simrs.backOffice.keuangan.hitungPremi.generateIcu.modal")
@endsection

@push("scripts")
    @include("simrs.backOffice.keuangan.hitungPremi.generateIcu.jsMain")
@endpush
