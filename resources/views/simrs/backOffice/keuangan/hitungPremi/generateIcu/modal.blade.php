        ...
        <form class="modal-content icu-modal-content" id="formGenerateIcu">
            <div class="modal-header icu-modal-header">
                <div class="icu-simple-main">
                    ...
                    <div>
                        <h5 class="modal-title mb-0">Preview Generate ICU</h5>
            ...
            <div class="modal-body">
                <div id="previewIcuLoading" class="text-center py-4">
                    ...
                    <div class="text-muted mt-2">Menghitung preview ICU...</div>
                </div>
                ...
                <div id="previewIcuContent" class="d-none">
                    <div class="icu-simple-head">
                        <div class="icu-simple-main">
                            ...
                            <div>
                                <div class="icu-simple-title" id="generateIcuTitle">Memuat preview...</div>
                                <div class="icu-simple-text" id="generateIcuText">Cek data tindakan dan nominal premi.</div>
                            </div>
                        </div>
                        <span class="icu-simple-badge" id="generateIcuTypeBadge">Jenis</span>
                    </div>
        ...
        <form class="modal-content icu-modal-content" id="formConfigIcu">
            <div class="modal-header icu-modal-header">
                <div class="icu-simple-main">
                    ...
                    <div>
                        <h5 class="modal-title mb-0">Konfigurasi Premi ICU</h5>
            ...
            <div class="modal-body">
                ...
                <div class="icu-simple-head">
                    <div class="icu-simple-main">
                        <div class="icu-simple-icon"><i class="mdi mdi-tune-variant"></i></div>
                        <div>
                            <div class="icu-simple-title" id="configIcuTitle">Konfigurasi ICU</div>
                ...
                <div class="icu-state-banner neutral" id="configIcuHealthBanner">
                    ...
                    <div>
                        ...
                        <div class="icu-state-text">Pilih mapping, tindakan kritikal, formula, dan penerima premi untuk jenis ICU aktif.</div>
                    </div>
                </div>

                <div class="icu-config-shell">
                    <aside class="icu-config-rail">
                        <div class="icu-config-heading">Aturan Data ICU</div>
                        ...
                        <div class="icu-config-pill-row">
                            <span class="icu-config-pill"><i class="mdi mdi-bed-outline me-1"></i> kamar_inap ICU</span>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-2">
                                Bisa memilih lebih dari satu jenis mapping. Tindakan dalam range ICU harus cocok dengan salah satunya.
                            </small>
                        </div>
                    ...
                    <div class="icu-config-main-card">
                        ...
                        <div class="row g-3 mb-3 icu-field-grid">
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Pool Perawat ICU</label>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Pegawai ICU Khusus</label>
                                <div class="input-group">
                                    <input type="number" step="0.0001" min="0" max="100" class="form-control"
                                        id="configPegawaiIcuKhususPercent">
                                    <span class="input-group-text">% dari ICU</span>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Perawat ICU Reguler</label>
                                <div class="input-group">
                                    <input type="number" step="0.0001" min="0" max="100" class="form-control"
                        ...
                        <div class="icu-recipient-grid mb-3">
                            ...
                            <div class="icu-recipient-panel">
                                ...
                                <div class="icu-recipient-help" id="countPegawaiIcuKhususRecipients">
                                    0 penerima dipilih untuk pool khusus ICU.
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content icu-modal-content">
            <div class="modal-header icu-modal-header">
                <div class="icu-simple-main">
                    ...
                    <div>
                        <h5 class="modal-title mb-0">Detail Generate ICU</h5>
            ...
            <div class="modal-body">
                <div id="detailIcuLoading" class="text-center py-5">
                    <span class="spinner-border text-danger"></span>
                    <div class="text-muted mt-2">Memuat detail ICU...</div>
                </div>
