...
<div class="modal fade" id="modalConfigBhp" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content border-0 rounded-3" id="formConfigBhp">
            <div class="modal-header border-0 pb-0">
                <div>
                    <h5 class="modal-title fw-bold" id="modalConfigBhpLabel">Konfigurasi Kamar</h5>
                    <small class="text-muted">Atur default nominal per hari inap untuk jenis aktif.</small>
                </div>
