...
@section("content")
    @include("simrs.settings.auth.permission.modalMain")
                ...
                <div class="card-body">
                    <div
                        ...
                        <div class="d-flex align-items-center mb-3 mb-md-0">
                            ...
                            <div>
                                <h5 class="fw-bold text-primary mb-1">Data Permissions</h5>
                                <small class="text-muted">Kelola dan cari data Permissions dengan cepat</small>
                            </div>
                        </div>
...
@push("scripts")
    @include("simrs.settings.auth.permission.jsMain")
@endpush
