...
<div class="modal fade" id="jenisPremiModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        ...
        <div class="modal-content border-0 shadow-sm rounded-4">
            ...
            <div class="modal-header border-0 pb-0">
                <div>
                    ...
                    <small class="text-muted">
                        Kelola jenis premi dan klasifikasi data
                    </small>
                </div>
            ...
            <div class="modal-body">
                ...
                <form id="jenisPremiForm">
                    @csrf

                    <!-- LIST -->
                    <div id="jenisPremiContainer" class="d-flex flex-column gap-3">
                        ...
                        <div class="card border-0 shadow-sm skor-item">
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <input type="text" name="jenisPremiId" id="jenisPremiId" value="">
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="submit" form="jenisPremiForm" class="btn btn-primary">
